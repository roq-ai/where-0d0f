...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'EventCreated.create': {
    roles: ['event-organizer', 'event-staff', 'business-owner', 'business-employee'],
    key: 'event',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['event-organizer', 'event-staff', 'business-owner', 'business-employee', 'end-user'];
