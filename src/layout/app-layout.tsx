...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['event-organizer', 'event-staff', 'business-owner', 'business-employee', 'end-user'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Events', path: '/events', entity: 'event', service: AccessServiceEnum.PROJECT, icon: FiClock },
    {
    ...
    { name: 'Likes', path: '/likes', entity: 'like', service: AccessServiceEnum.PROJECT, icon: FiThumbsUp },
    { name: 'Locations', path: '/locations', entity: 'location', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
    { name: 'Posts', path: '/posts', entity: 'post', service: AccessServiceEnum.PROJECT, icon: FiMessageSquare },
    {
      name: 'User Followers',
      path: '/user-followers',
