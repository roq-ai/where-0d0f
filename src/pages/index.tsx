  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience WHERE, your social media platform for sharing pictures and videos of nearby events. Stay connected, informed, and tell your story with WHERE."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1535303311164-664fc9ec6532?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzb2NpYWwlMjBtZWRpYXxlbnwwfHx8fDE2OTU2MjI4Nzl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience WHERE, your social media platform for sharing pictures and videos of nearby events. Stay connected, informed, and tell your story with WHERE.`}
            </Text>
            <Box
